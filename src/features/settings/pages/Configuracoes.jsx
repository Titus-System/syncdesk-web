      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden min-w-0">
        ...
        <div className="flex-1 overflow-y-auto p-6 lg:p-10">
          <div className="w-full max-w-3xl mx-auto">
            <div className="mb-4">
              <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Configurações da Conta</h1>
              <p className="text-gray-500 text-sm mt-1.5 font-medium opacity-60">
                Gerencie suas informações de perfil, preferências de segurança e notificações do sistema.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 mb-6">
              <div className="flex items-center gap-2 mb-6">
                <UserIcon size={16} className="text-[#BD3B0F]" />
                <h2 className="text-sm font-bold text-gray-900 uppercase tracking-wide">Informações do Perfil</h2>
              </div>
 
              <form onSubmit={handleSalvar} className="flex flex-col gap-6">
                <div className="flex items-center gap-6">
                  <div className="w-16 h-16 rounded-full bg-orange-100 text-orange-700 flex items-center justify-center text-xl font-bold shrink-0">
                    {initials}
                  </div>
                </div>
                ...
                <div>
                  <button
                    ...
                    className="bg-[#BD3B0F] hover:bg-[#9a2f0d] text-white font-bold py-3 px-8 rounded-lg shadow-sm flex items-center gap-2 text-sm uppercase tracking-wide disabled:opacity-50 transition-all"
                  >
